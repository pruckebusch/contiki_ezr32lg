...
#define GPIO_UART1_TX   				GPIO_PD7
#define GPIO_UART1_RX   				GPIO_PD6
#else
#error "Unknown Location for UART1"
#endif

#define GPIO_USER_LED1 					GPIO_PF6
#define GPIO_USER_LED2 					GPIO_PF7

#define PORT_LED1       				gpioPortF
#define PORT_PIN_LED1					6
#define PORT_LED2       				gpioPortF
#define PORT_PIN_LED2  					7

#define GPIO_USER_BTN1					GPIO_PE3
#define GPIO_USER_BTN2					GPIO_PE2

#define PORT_BTN1						gpioPortE
#define PORT_PIN_BTN1					3
#define PORT_BTN2						gpioPortE
#define PORT_PIN_BTN2					2
...
#define NETSTACK_CONF_RADIO				ezradio_driver
#define NETSTACK_RADIO_MAX_PAYLOAD_LEN	64
